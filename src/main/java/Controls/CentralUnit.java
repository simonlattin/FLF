...
public class CentralUnit {
    ...
    public CentralUnit(){
        ...
        frontAxis = new Axis(Position.FRONT);
        rightSide1 = new SideLight(Lights.Position.RIGHT);
        rightSide2 = new SideLight(Lights.Position.RIGHT);
        rightSide3 = new SideLight(Lights.Position.RIGHT);
        rightSide4 = new SideLight(Lights.Position.RIGHT);
        rightSide5 = new SideLight(Lights.Position.RIGHT);
        leftSide1 = new SideLight(Lights.Position.LEFT);
        leftSide2 = new SideLight(Lights.Position.LEFT);
        leftSide3 = new SideLight(Lights.Position.LEFT);
        leftSide4 = new SideLight(Lights.Position.LEFT);
        leftSide5 = new SideLight(Lights.Position.LEFT);
        spotlight01 = new Spotlight(Lights.Position.FRONTLEFT);
        spotlight02 = new Spotlight(Lights.Position.FRONTLEFT);
        spotlight03 = new Spotlight(Lights.Position.FRONTLEFT);
        spotlight04 = new Spotlight(Lights.Position.FRONTRIGHT);
        spotlight05 = new Spotlight(Lights.Position.FRONTRIGHT);
        spotlight06 = new Spotlight(Lights.Position.FRONTRIGHT);
        spotlight07 = new Spotlight(Lights.Position.ROOF);
        spotlight08 = new Spotlight(Lights.Position.ROOF);
        spotlight09 = new Spotlight(Lights.Position.ROOF);
        spotlight10 = new Spotlight(Lights.Position.ROOF);
        indicator01 = new Indicator(Lights.Position.FRONTLEFT);
        indicator02 = new Indicator(Lights.Position.FRONTRIGHT);
        indicator03 = new Indicator(Lights.Position.BACKLEFT);
        indicator04 = new Indicator(Lights.Position.BACKRIGHT);
        breakLight01 = new BreakLight(Lights.Position.BACKLEFT);
        breakLight02 = new BreakLight(Lights.Position.BACKRIGHT);
        blueLight01 = new BlueLight(Size.SMALL, Lights.Position.FRONT);
        blueLight02 = new BlueLight(Size.SMALL, Lights.Position.FRONT);
        blueLight03 = new BlueLight(Size.BIG, Lights.Position.ROOF);
        blueLight04 = new BlueLight(Size.BIG, Lights.Position.ROOF);
        blueLight05 = new BlueLight(Size.BIG, Lights.Position.ROOF);
        blueLight06 = new BlueLight(Size.BIG, Lights.Position.ROOF);
        blueLight07 = new BlueLight(Size.MEDIUM, Lights.Position.BACKRIGHT);
        blueLight08 = new BlueLight(Size.MEDIUM, Lights.Position.BACKRIGHT);
        blueLight09 = new BlueLight(Size.MEDIUM, Lights.Position.BACKLEFT);
        blueLight10 = new BlueLight(Size.MEDIUM, Lights.Position.BACKLEFT);
    ...
    public void turn(int winkel){
        ...
        System.out.println("The steering degree is " + frontAxis.getSteeringDegree() + "°.");
    }
